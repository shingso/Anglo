      ...
      <Screen style={$root} preset="scroll">
        <View style={$container}>
          ...
          <Section
            title={"Overview"}
            body={[
              "This website is operated by Spaced Memo. Throughout the site, the terms “we”, “us” and “our” refer to Spaced Repetition. Spaced Repetition offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.",
