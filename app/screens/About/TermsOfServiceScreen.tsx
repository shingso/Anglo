...
// - Add `TermsOfService: undefined` to AppStackParamList
...
// @ts-ignore
export const TermsOfServiceScreen: FC<StackScreenProps<AppStackScreenProps, "TermsOfService">> =
      ...
      return (
        <View style={{ marginBottom: spacing.size160 }}>
          ...
          {body &&
            body.map((text, index) => {
              return (
                <CustomText style={{ marginBottom: spacing.size80 }} key={index}>
                  {text}
                </CustomText>
              )
            })}
    ...
    return (
      <Screen style={$root} preset="scroll">
        <View style={$container}>
          <CustomText style={$title} preset="title1">
            Terms of Service
          </CustomText>
          <Section
            title={"Overview"}
            body={[
              "This website is operated by Spaced Repetition. Throughout the site, the terms “we”, “us” and “our” refer to Spaced Repetition. Spaced Repetition offers this website, including all information, tools and Services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here.",
          ...
          ></Section>
          <Section
            title={"Accuracy, completeness and timelineess of information"}
            body={[
          ...
          <Section
            ...
            body={[
              "You agree to indemnify, defend and hold harmless Spaced Repetition and our parent, subsidiaries, affiliates, partners, officers, directors, agents, contractors, licensors, service providers, subcontractors, suppliers, interns and employees, harmless from any claim or demand, including reasonable attorneys’ fees, made by any third-party due to or arising out of your breach of these Terms of Service or the documents they incorporate by reference, or your violation of any law or the rights of a third-party.",
            ]}
          ></Section>
          <Section
            title={"Serverability"}
